...
<li> Each of update , create , delete function does excist in the same controller , now a user token is valid for 1 hour , for that case each of those methods are linked with refresh token api to get the new token <p align="center"><img src="https://github.com/lilfrou/calender/blob/master/public/media/read_me/try_catch.png" width="400"></p> </li>
    <li>there are a few other things to mention , the email verification blade is using an auto refresh function , by that it is using a zomm api to check if the user has confirmed his mail , the function does excist in the homeController   <p align="center"><img src="https://github.com/lilfrou/calender/blob/master/public/media/read_me/refresh.png" width="400"></p> </li>
    <li> the auto refresh function is pointing to the HomeController index function where it checks for all condition to redirect the user to dashboard page  <p align="center"><img src="https://github.com/lilfrou/calender/blob/master/public/media/read_me/dashboard.png" width="400"></p></li>
    <li> this function is responsable for checking the email confirmation   <p align="center"><img src="https://github.com/lilfrou/calender/blob/master/public/media/read_me/email.png" width="400"></p></li>
